  ...
  return (
    <div className="w-full bg-gradient-to-b from-amber-50 via-orange-50 to-amber-50">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
        <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-amber-900 text-center mb-16">
          Our Journey
        </h2>
        <div className="max-w-5xl mx-auto">
          <div className="relative">
            {/* Timeline Line */}
            <div className="absolute left-1/2 transform -translate-x-1/2 h-full w-1 bg-gradient-to-b from-amber-400 via-red-500 to-amber-600 hidden md:block"></div>
            ...
            {milestones.map((milestone, index) => (
              ...
              >
                ...
                <div className="relative flex items-center justify-center w-full md:w-2/12">
                  <div className="w-8 h-8 bg-gradient-to-br from-amber-500 to-red-600 rounded-full border-4 border-white shadow-lg z-10"></div>
                </div>
                <div
