...
export default function TestimonialPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    formData.append("weddingDate", form.weddingDate.trim());
    ...
    <div className="min-h-screen bg-gradient-to-b from-rose-50 to-white pt-24 font-sans">
      ...
      <section className="py-16 px-4 bg-rose-50">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <a
            href="/contact"
            className="inline-flex items-center gap-2 bg-rose-500 text-white px-8 py-3 rounded-full font-semibold hover:bg-rose-600 transition"
          >
            Start Planning Today <Heart className="w-5 h-5" />
          </a>
        </div>
      </section>
